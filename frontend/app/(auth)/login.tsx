...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // _layout.tsx handles navigation after isAuthenticated flips
    } catch (err: any) {
      const msg =
...
const styles = StyleSheet.create({
  ...
  forgotPasswordBtn: { alignSelf: 'center', paddingVertical: 8, marginBottom: 4 },
  forgotPasswordText: { fontSize: 13, color: Colors.primary, fontWeight: '500' },
});
