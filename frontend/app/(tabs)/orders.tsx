...
export default function OrdersScreen() {
  ...
  // Batch-update product_id + unit_price together to avoid stale-closure overwrite
  const selectOrderProduct = (index: number, productId: string, price: number) => {
    setOrderForm(prev => {
      const newItems = [...prev.items];
      newItems[index] = { ...newItems[index], product_id: productId, unit_price: price.toString() };
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() => {
                            selectOrderProduct(
                              index,
                              p.product_id,
                              activeTab === 'purchase' ? p.cost_price : p.selling_price
                            );
                          }}
                        >
                          <Text
